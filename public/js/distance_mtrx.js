  ...
  // function initialize() {
  //     myLatlng = new google.maps.LatLng(37.786906, -122.410156);
  //     var myOptions = {
  //         zoom: 15,
  //         center: myLatlng,
  ...
  function addResult(result, i, distance) {
      ...
      opt.style.backgroundColor = (i % 2 == 0 ? '#F0F0F0' : '#FFFFFF');
      ...
      var name = document.createTextNode(result.name + ' - ' + distance + ' m ');

      nameTd.appendChild(name);

      opt.appendChild(nameTd);
